...
function link_svg(svg, csv, svg_location, csv_location, debug = false, hover_color = 'yellow', width = '100%', height = '100%', modal_id = 'modal', modal_url_pfx = 'https://marinebon.org/fk-esr-info/', text_list = true, colored_sections = false, section_colors = ['green', 'purple', 'orange']) {
  ...
  d3.xml(svg).then((f) => {
    ...
    d3.csv(csv).then(function(data) {
      ...
      if (text_list === false){csv_location="nowhere"};
