...
function link_svg(svg, csv, svg_location, csv_location, debug = false, hover_color = 'yellow', width = '100%', height = '100%', modal_id = 'modal', modal_url_pfx = 'https://marinebon.org/fk-esr-info/', colored_sections = false, section_colors = ['green', 'purple', 'orange']) {
